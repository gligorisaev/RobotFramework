...
Device is connected to Cumulocity
    Get Data    #Timestamp, Build, Architecture
    Set File Name    #Defining File name to download 
...
exists
    ...
    # SSHLibrary.Execute Command    sudo dpkg -P tedge_logfile_request_plugin
...
# Install Tedge logfile request plugin
    # ${output}=    SSHLibrary.Execute Command    sudo dpkg -i ./tedge_logfile_request_plugin_${Version}_arm*.deb
